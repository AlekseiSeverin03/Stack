...
{                                                                                                                  
    ...
    } else if (code_error == NULL_STACK_PTR) {                                                                               
    ...
    } else if (code_error == NULL_DATA_PTR) {                                                                               
    ...
    } else if (code_error == DATA_PTR_IS_ERR_PTR) {                                                                        
...
void StackDtor (Stack *stack_ptr)
{
    ...
    if (stack_ptr->data == (elem_t *) ERR_PTR)
    {
        fprintf (LOG_FILE, "\n<!> Attempting to destroy an already destroyed stack <!>\n");
    }
...
int StackPop (Stack *stack_ptr, elem_t *ptr_place)               
{
    StackCheck (stack_ptr);
                ...
                const int num_line)
{
    ...
    if (stack_ptr->size + LITTLE_N_ELEMENT >= stack_ptr->capacity)
    {
    ...
    {
        for (int i = 0; i < LITTLE_N_ELEMENT - 1; i++)
        {
